...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    role: "VP Engineering",
    company: "Brightpath",
    text: "We benchmarked five agencies. Boolbit was the only one that asked about business outcomes before talking tech. Hired on the spot.",
    rating: 5,
    initials: "EC",
  },
  {
  ...
  },
  {
    ...
    role: "CEO",
    company: "OrbitOps",
    text: "Senior team, fair pricing, and shipped early. I've worked with a dozen agencies — Boolbit is in a different league.",
    rating: 5,
    initials: "JW",
  },
];
